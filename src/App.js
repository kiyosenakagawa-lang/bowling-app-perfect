    ...
    <div className="min-h-screen bg-gray-100 text-gray-800 font-sans pb-20 print:pb-0 print:bg-white">
      ...
      <main className="max-w-4xl mx-auto p-4 print:p-0">
        ...
        <div className={activeTab === 'preview' ? 'block print:block' : 'hidden print:block'}>
          <div className="print-hidden mb-3 text-sm text-gray-600 bg-blue-50 border border-blue-200 p-3 rounded-lg flex items-center justify-between">
            <div className="flex items-center"><FileText className="w-5 h-5 mr-2 text-blue-500 shrink-0" /><span>メニューからブラウザで開いて印刷して下さい。</span></div>
          ...
          <div className="overflow-x-auto w-full bg-gray-300 p-4 sm:p-8 rounded-xl shadow-inner print:p-0 print:bg-white print:overflow-visible print:shadow-none">
